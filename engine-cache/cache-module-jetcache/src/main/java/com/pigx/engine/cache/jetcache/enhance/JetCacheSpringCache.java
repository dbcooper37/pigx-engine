...
public class JetCacheSpringCache extends AbstractValueAdaptingCache {
    ...
    protected Object lookup(Object key) {
        ...
        if (ObjectUtils.isNotEmpty(value)) {
            log.trace("[PIGXD] |- CACHE - Lookup data in herodotus cache, value is : [{}]", Jackson2Utils.toJson(value));
            return value;
        }
    ...
    public <T> T get(Object key, Callable<T> valueLoader) {
        ...
        log.trace("[PIGXD] |- CACHE - Get data in herodotus cache, key: {}", key);
    ...
    public void put(Object key, @Nullable Object value) {
        log.trace("[PIGXD] |- CACHE - Put data in herodotus cache, key: {}", key);
    ...
    public ValueWrapper putIfAbsent(Object key, @Nullable Object value) {
        log.trace("[PIGXD] |- CACHE - PutIfPresent data in herodotus cache, key: {}", key);
    ...
    public void evict(Object key) {
        log.trace("[PIGXD] |- CACHE - Evict data in herodotus cache, key: {}", key);
        cache.remove(key);
    }

    @Override
    public boolean evictIfPresent(Object key) {
        log.trace("[PIGXD] |- CACHE - EvictIfPresent data in herodotus cache, key: {}", key);
        return cache.remove(key);
    }

    @Override
    public void clear() {
        log.trace("[PIGXD] |- CACHE - Clear data in herodotus cache.");
        cache.close();
    }
}
