...
public class HerodotusMybatisCache implements Cache {
    ...
    public void putObject(Object key, Object value) {
        ...
        log.debug("[PIGXD] |- CACHE - Put data into Mybatis Cache, with key: [{}]", key);
    }

    @Override
    public Object getObject(Object key) {
        Object obj = cache.get(key);
        log.debug("[PIGXD] |- CACHE - Get data from Mybatis Cache, with key: [{}]", key);
        return obj;
    }
    ...
    public Object removeObject(Object key) {
        ...
        log.debug("[PIGXD] |- CACHE - Remove data from Mybatis Cache, with key: [{}]", key);
        return obj;
    }
    ...
    public void clear() {
        cache.close();
        log.debug("[PIGXD] |- CACHE - Clear Mybatis Cache.");
    }
