...
public class ResourceResolverUtils {
    ...
    public static Resource getResource(String location) {
        ...
        log.debug("[PIGXD] |- Resource at location [{}] is [{}]!", location, resource.exists());
        return resource;
    }
    ...
    public static File getFile(String location) {
        ...
        try {
            ...
            log.warn("[PIGXD] |- File not found in location [{}]", location, e);
            return new File(location);
        } catch (IOException e) {
            log.error("[PIGXD] |- Cannot found resource use location [{}]", location);
            return new File(location);
        }
    }
    ...
    public static byte[] toBytes(Resource resource) {
        try {
            ...
            log.error("[PIGXD] |- Converter resource to byte[] error!", e);
            return null;
        }
    }
    ...
    public static Map<String, String> getBase64Images(String locationPattern) {
        if (ResourceResolverUtils.isClasspathAllUrl(locationPattern)) {
            try {
                ...
                log.error("[PIGXD] |- Analysis the  location [{}] catch io error!", locationPattern, e);
            }
        }
