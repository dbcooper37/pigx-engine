...
public class WxappProcessor {
    ...
    private Map<String, WxMaService> initWxMaServices(WxappProperties wxappProperties, Map<String, WxMaMessageRouter> wxMaMessageRouters) {
        ...
        if (CollectionUtils.isNotEmpty(configs)) {
            ...
            log.info("[PIGXD] |- Bean [Weixin Mini App] Configure.");
...
//                WxMaDefaultConfigImpl config = new WxMaRedisConfigImpl(new JedisPool());
    ...
    public WxMaService getWxMaService() {
        ...
        if (StringUtils.isBlank(appId)) {
            log.error("[PIGXD] |- Must set [herodotus.platform.social.wxapp.default-app-id] property, or use getWxMaService(String appid)!");
    ...
    private WxMaJscode2SessionResult getSessionInfo(String code, WxMaService wxMaService) {
        try {
            ...
            log.debug("[PIGXD] |- Weixin Mini App login successfully!");
            return sessionResult;
        } catch (WxErrorException e) {
            log.error("[PIGXD] |- Weixin Mini App login failed! For reason: {}", e.getMessage());
            return null;
        }
    }
    ...
    public WxMaJscode2SessionResult login(String code, String appId) {
        ...
        if (StringUtils.isNotBlank(code) && ObjectUtils.isNotEmpty(wxMaService)) {
            ...
            log.error("[PIGXD] |- Weixin Mini App login failed, please check code param!");
            return null;
        }
    }
    ...
    private boolean checkUserInfo(String sessionKey, String rawData, String signature, WxMaService wxMaService) {
        if (wxMaService.getUserService().checkUserInfo(sessionKey, rawData, signature)) {
            log.debug("[PIGXD] |- Weixin Mini App user info is valid!");
            return true;
        } else {
            log.warn("[PIGXD] |- Weixin Mini App user check failed!");
            return false;
        }
    }
    ...
    private WxMaUserInfo getUserInfo(String sessionKey, String encryptedData, String iv, WxMaService wxMaService) {
        ...
        log.debug("[PIGXD] |- Weixin Mini App get user info successfully!");
        return wxMaUserInfo;
    }
    ...
    public WxMaUserInfo getUserInfo(String appId, String sessionKey, String encryptedData, String iv, String rawData, String signature) {
        ...
        if (ObjectUtils.isNotEmpty(wxMaService)) {
            ...
            log.error("[PIGXD] |- Weixin Mini App get user info failed!");
            return null;
        }
    }
    ...
    private WxMaPhoneNumberInfo getPhoneNumberInfo(String code, WxMaService wxMaService) {
        log.info("[PIGXD] |- Weixin Mini App get code： {}", code);

        WxMaPhoneNumberInfo wxMaPhoneNumberInfo;
        try {
            wxMaPhoneNumberInfo = wxMaService.getUserService().getPhoneNumber(code);
            log.debug("[PIGXD] |- Weixin Mini App get phone number successfully! WxMaPhoneNumberInfo : {}", wxMaPhoneNumberInfo.toString());
            return wxMaPhoneNumberInfo;
        } catch (Exception e) {
            log.error("[PIGXD] |- Weixin Mini App get phone number failed!");
            return null;
        }
    }
    ...
    public WxMaPhoneNumberInfo getPhoneNumberInfo(String appId, String sessionKey, String rawData, String signature, String code) {
        ...
        if (ObjectUtils.isNotEmpty(wxMaService)) {
            ...
            log.error("[PIGXD] |- Weixin Mini App get phone number info failed!");
            return null;
        }
    }
    ...
    public boolean sendSubscribeMessage(String appId, WxMaSubscribeMessage subscribeMessage) {
        try {
            ...
            log.debug("[PIGXD] |- Send Subscribe Message Successfully!");
            return true;
        } catch (WxErrorException e) {
            log.debug("[PIGXD] |- Send Subscribe Message Failed!", e);
            return false;
        }
    }
    ...
    public boolean checkMessage(String appId, String message) {
        try {
            ...
            log.debug("[PIGXD] |- Check Message Successfully!");
            return true;
        } catch (WxErrorException e) {
            log.debug("[PIGXD] |- Check Message Failed!", e);
            return false;
        }
    }
    ...
    public boolean checkImage(String appId, String fileUrl) {
        try {
            ...
            log.debug("[PIGXD] |- Check Image use fileUrl Successfully!");
            return true;
        } catch (WxErrorException e) {
            log.debug("[PIGXD] |- Check Image use fileUrl Failed! Detail is ：{}", e.getMessage());
            return false;
        }
    }
    ...
    public boolean checkImage(String appId, File file) {
        try {
            ...
            log.debug("[PIGXD] |- Check Image use file Successfully!");
            return true;
        } catch (WxErrorException e) {
            log.debug("[PIGXD] |- Check Image use file Failed! Detail is ：{}", e.getMessage());
            return false;
        }
    }
    ...
    public WxMaMediaAsyncCheckResult mediaAsyncCheck(String appId, String mediaUrl, int mediaType) {
        ...
        try {
            ...
            log.debug("[PIGXD] |- Media Async Check Successfully!");
        } catch (WxErrorException e) {
            log.debug("[PIGXD] |- Media Async Check Failed! Detail is ：{}", e.getMessage());
        }
