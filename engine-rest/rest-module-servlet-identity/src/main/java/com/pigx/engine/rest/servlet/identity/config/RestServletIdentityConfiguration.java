...
@ComponentScan(basePackages = {"com.pigx.engine.rest.servlet.identity.service", "com.pigx.engine.rest.servlet.identity.controller"})
/* loaded from: rest-module-servlet-identity-3.5.7.0.jar:cn/herodotus/engine/rest/servlet/identity/config/RestServletIdentityConfiguration.class */
