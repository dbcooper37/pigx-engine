...
/* loaded from: oauth2-module-persistence-jpa-3.5.7.0.jar:cn/herodotus/engine/oauth2/persistence/sas/jpa/jackson2/ClientSettingsDeserializer.class */
public class ClientSettingsDeserializer extends JsonDeserializer<ClientSettings> {
    /* renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public ClientSettings m221deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JacksonException {
