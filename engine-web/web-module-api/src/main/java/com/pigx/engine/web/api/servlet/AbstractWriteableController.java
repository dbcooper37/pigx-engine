...
/* loaded from: web-module-api-3.5.7.0.jar:cn/herodotus/engine/web/api/servlet/AbstractWriteableController.class */
public abstract class AbstractWriteableController<E extends BaseEntity, ID extends Serializable, S extends BasePageService<E, ID>> extends AbstractReadableController<E, ID, S> {
    ...
    @Idempotent
    public Result<E> save(@org.springframework.web.bind.annotation.RequestBody E domain) {
