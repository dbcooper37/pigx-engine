...
/* loaded from: web-module-servlet-3.5.7.0.jar:cn/herodotus/engine/web/servlet/crypto/DecryptRequestParamMapResolver.class */
public class DecryptRequestParamMapResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter methodParameter) {
        ...
        log.trace("[Herodotus] |- Is DecryptRequestParamMapResolver supports method [{}] ? Status is [{}].", methodName, Boolean.valueOf(isSupports));
        return isSupports;
    }
    ...
    private boolean isRegularMap(MethodParameter methodParameter) {
        if (!MultiValueMap.class.isAssignableFrom(methodParameter.getParameterType())) {
            ...
            return (valueType == MultipartFile.class || valueType == Part.class) ? false : true;
        }
        return false;
    }
